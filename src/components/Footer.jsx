...
const Footer = () => {
    ...
    useEffect(()=>{
      const loadData = async ()=>{
        ...
        if(path === '/searching-opravar'||path==='/searching-zakaznik'||path==='/profile/:userId'||path==='/recenze/:userId'){setBtnImages([greyHouseImg, whiteLupaImg,  greyZvonekImg, greyProfilImg])}
